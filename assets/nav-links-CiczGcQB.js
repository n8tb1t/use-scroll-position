import { a as reactExports, o as jsxRuntimeExports, N as NavLink } from "./chunk-NL6KNZEE-Cz7MpE0V.js";
var n = typeof window < "u";
var u = n ? reactExports.useLayoutEffect : reactExports.useEffect;
var x = { x: 0, y: 0 }, E = (o) => o == null ? void 0 : o.getBoundingClientRect(), P = ({ useWindow: o, target: f, root: i }) => {
  if (!n) return x;
  if (o) return { x: window.scrollX, y: window.scrollY };
  let t = E(i == null ? void 0 : i.current), e = E((f == null ? void 0 : f.current) || document.body);
  return e ? t ? { x: (t.x || 0) - (e.x || 0), y: (t.y || 0) - (e.y || 0) } : { x: e.left, y: e.top } : x;
};
var S = (o, f, i, t, e, r2) => {
  let a = reactExports.useRef({ x: 0, y: 0 }), s = reactExports.useRef(void 0), y = reactExports.useRef(o);
  y.current = o;
  let c = reactExports.useCallback(() => {
    let R = P({ useWindow: t, root: r2, target: i });
    y.current({ prevPos: a.current, currPos: R }), a.current = R;
  }, [t, r2, i]), m = reactExports.useCallback(() => {
    c(), s.current = void 0;
  }, [c]), l = reactExports.useCallback(() => {
    e ? s.current === void 0 && (s.current = setTimeout(m, e)) : m();
  }, [m, e]);
  u(() => {
    c();
  }, [c]), u(() => {
    if (n) return window.addEventListener("scroll", l, { passive: true }), () => {
      window.removeEventListener("scroll", l), s.current && clearTimeout(s.current);
    };
  }, f);
};
function r(e) {
...
const LoremIpsum = reactExports.memo(({ className }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(className, "grid gap-4 p-14 text-sm"), children: ipsum.map((paragraph, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: paragraph }, index)) }));
const base = cn([
...
const NavLinks = ({ variant }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full", children: [
  ...
  NavLink,
  {
    ...
    to: route,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "z-1", children: caption })
  },
  caption
)) });
export {
